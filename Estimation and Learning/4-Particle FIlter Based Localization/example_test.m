...
hold on;
pose1 = particleLocalization(ranges(:,1:1000), scanAngles, M, param);


%% Plot final solution
% The final grid map:

plot(pose1(1,:)*param.resol+param.origin(1), ...
    pose1(2,:)*param.resol+param.origin(2), 'b.-');